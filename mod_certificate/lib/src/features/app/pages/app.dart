...
import 'package:mod_certificate/src/common/navigation/app_router.dart';
import 'package:mod_certificate/src/common/navigation/configurations.dart';
import 'package:mod_certificate/src/features/app/cubit/app_cubit.dart';

class ModCertificateApp extends StatefulWidget {
  const ModCertificateApp({super.key});

  @override
  State<ModCertificateApp> createState() => _ModCertificateAppState();
}

class _ModCertificateAppState extends State<ModCertificateApp> {
