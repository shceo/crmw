...
import 'package:pa_admin/src/common/cubit_scope/cubit_scope.dart';
import 'package:pa_admin/src/common/di/injector.dart';
import 'package:pa_admin/src/common/navigation/app_router.dart';
import 'package:pa_admin/src/common/navigation/configurations.dart';
import 'package:pa_admin/src/features/app/cubit/app_cubit.dart';

class PaAdminApp extends StatefulWidget {
  const PaAdminApp({super.key});

  @override
  State<PaAdminApp> createState() => _PaAdminAppState();
}

class _PaAdminAppState extends State<PaAdminApp> {
  ...
  void initState() {
    ...
    final initialConfig = signInConfig();
