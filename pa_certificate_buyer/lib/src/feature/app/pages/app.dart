...
import 'package:pa_certificate_buyer/src/common/navigation/app_router.dart';
import 'package:pa_certificate_buyer/src/common/navigation/configurations.dart';
import 'package:pa_certificate_buyer/src/feature/app/cubit/app_cubit.dart';


class PaCertificateBuyerApp extends StatefulWidget {
  const PaCertificateBuyerApp({super.key});

  @override
  State<PaCertificateBuyerApp> createState() => _PaCertificateBuyerAppState();
}

class _PaCertificateBuyerAppState extends State<PaCertificateBuyerApp> {
  ...
  void initState() {
    ...
    final initialConfig = certificateBuyerConfig();
