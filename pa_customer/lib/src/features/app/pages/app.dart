...
import 'package:pa_customer/src/common/navigation/app_router.dart';
import 'package:pa_customer/src/common/navigation/configurations.dart';
import 'package:pa_customer/src/features/app/cubit/app_cubit.dart';

class PaCustomerApp extends StatefulWidget {
  const PaCustomerApp({super.key});

  @override
  State<PaCustomerApp> createState() => _PaCustomerAppState();
}

class _PaCustomerAppState extends State<PaCustomerApp> {
  ...
  void initState() {
    ...
    final initialConfig = reserveConfig();
