...
import 'package:pa_partner/src/common/navigation/configurations.dart';
import 'package:pa_partner/src/features/app/cubit/app_cubit.dart';

class PaPartnerApp extends StatefulWidget {
  const PaPartnerApp({super.key});

  @override
  State<PaPartnerApp> createState() => _PaPartnerAppState();
}

class _PaPartnerAppState extends State<PaPartnerApp> {
