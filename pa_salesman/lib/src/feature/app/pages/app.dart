...
import 'package:pa_salesman/src/common/navigation/app_router.dart';
import 'package:pa_salesman/src/common/navigation/configurations.dart';
import 'package:pa_salesman/src/feature/app/cubit/app_cubit.dart';

class PaSalesmanApp extends StatefulWidget {
  const PaSalesmanApp({super.key});

  @override
  State<PaSalesmanApp> createState() => _PaSalesmanAppState();
}

class _PaSalesmanAppState extends State<PaSalesmanApp> {
